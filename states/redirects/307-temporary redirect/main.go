...
//after filling the form in "/say", the root path method of will be post.
//"/say" remains get because nothing changed about it
//"/red" becomes post becomes it but does not change the method of to root to get cos of http.statustempoararyredirect
